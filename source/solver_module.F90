...
! dynamo_pot and dynamo_fac can not both be true
   ...
   ! use input_mod,only:dynamo_pot,dynamo_fac
    use mpi_module,only:mag_lon_size,mag_rank, &
...
!-----------------------------------------------------------------------
  subroutine gather_lhs(root,mlond0,mlond1,n, &
    ...
    use mpi_module,only:mag_maxlat,mag_maxlon,mag_size,mag_lon_size, &
...
! reconstructed global LHS matrix
    ...
    type(MPI_Request),dimension(0:mag_lon_size) :: request
...
!-----------------------------------------------------------------------
  function gather_rhs(root,n,gidx_l,rhs_l) result(rhs)
    ...
    use mpi_module,only:mag_maxlat,mag_maxlon,mag_size,mag_world,mpi_rp, &
